...
*/
  ...
  //G4VSolid* poreOuterBox = new G4Box("poreOuterBox", 13.0  *um, 13.0  *um, 0.6*mm); // full size 26 x 26 um x 1.2 mm
  //G4VSolid* poreInnerBox = new G4Box("poreInnerBox", 10.025*um, 10.025*um, 0.6*cm); // full size 20.05 x 20.05 um
  //G4VSolid* poreSolid = new G4SubtractionSolid("poreSolid", poreOuterBox, poreInnerBox, 0, G4ThreeVector(0,0,0));

  /// pore pitch = atan(26.0um/2/750mm)*2 = 3.466666666319486e-05 radian
  //const G4double poreAngleStep = 3.466666666319486e-05; 
  ...
  const G4int nxpole = 1540;
  const G4int nypole = 1540;
